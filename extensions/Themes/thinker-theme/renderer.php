	...
	class renderer
	{
		function get_icon($category)
		{
			...
			if ($show_menu_category_icons)
				$img = $category == '' ? 'right.png' : $category.'.png';
			else	
				$img = 'right.png';
			return "";
		}
		...
		{
			global $path_to_root, $help_base_url, $db_connections, $power_url;
			...
			echo "<tr>\n";
			echo "<td>\n"; // We have chosen our own logo, Joe
			echo "<table width='100%' border='0' cellpadding='0' cellspacing='0'>\n";
			echo "<tr>\n";
			echo "<td class='quick_menu'>\n"; // tabs
			if (!$no_menu)
			{
				echo "<div class='hdrlogo'><a  href='$power_url'><img src='$path_to_root/themes/".user_theme(). "/images/logo_frontaccounting2.png' alt='FrontAccounting' style='padding-bottom: 10px;' onload='fixPNG(this)' border='0' /></a></div>";
				echo "<table width='100%' border='0' cellpadding='0' cellspacing='0'>\n";
				echo "<tr>\n";
				echo "<td class='quick_menu'>\n";
				...
				echo "<td class='logoutBarRight'></td>";
				echo "  <td class='logoutBarRight'><div class='logoout'><a class='shortcut' href='$path_to_root/admin/display_prefs.php?'>" . _("Likings") . "</a>\n";
				...
				{
					echo "  <a target = '_blank' onclick=" .'"'."javascript:openWindow(this.href,this.target); return false;".'" '. "href='". help_url()."'>" . _("Help") . "</a>";
				}
				echo "  <a class='shortcut' href='$local_path_to_root/access/logout.php?'>" . _("Logout") . "</a>";
				echo "</div><img id='ajaxmark' src='$indicator' align='right' style='visibility:hidden;'></td></tr><tr><td colspan=3>";
				echo "</td></tr></table>";
				echo "</td></tr></table>";
			}
		...
		function menu_footer($no_menu, $is_index)
		{
			...
			if ($no_menu == false)
			{
				...
				if (isset($_SESSION['wa_current_user'])) {
					...
					echo "<td class=bottomBarCell>" . Today() . " "  ."<span style=float:right;>"."<font color='#ffffff'>". "  ".show_users_online()."</font>". "</span></td>\n";
