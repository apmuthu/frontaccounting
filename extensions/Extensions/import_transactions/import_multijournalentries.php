...
//Module contents
//./Import_multijournalentries/import_multijournalentries.php
//./Import_multijournalentries/template/bank.csv                                       .......for bank statement processing......users process bank.csv twice. once with 'deposit processing' and once with 'payment processing'.
//./Import_multijournalentries/template/deposit.csv                                    .......for non-bank statement deposit processing...deposit.csv
//./Import_multijournalentries/template/payment.csv                                    .......for non-bank statement payment processing...payment.csv
//./Import_multijournalentries/template/journal.csv                                    .......for non-bank journal processing.............journal.csv
//./Import_multijournalentries/includes/import_multijournalentries.inc                 .......include file containing functions used here.
...
page(_($help_context = "Import Multiple Journal Entries / Deposits / Payments"), false, false, "", $js);
...
initialize_controls();
start_outer_table(TABLESTYLE2, "width=95%");//outer table
...
div_end('_main_table');
end_form();
//div_end('_page_body'); //div crucial for specific page updates through Ajax 
end_page();
?>