...
if ($Mode == 'ADD_ITEM' && can_process()) {
    add_payroll_pay_type($_POST['code'], $_POST['name'], isset($_POST['taxable']) ? 1 : 0, $_POST['cmethod'], $_POST['account_code'], input_num('default_rate'), isset($_POST['required']) ? 1 : 0, isset($_POST['automatic']) ? 1 : 0);
...
if ($Mode == 'UPDATE_ITEM' && can_process()) {
    update_payroll_pay_type($selected_id, $_POST['code'], $_POST['name'], isset($_POST['taxable']) ? 1 : 0, $_POST['cmethod'], $_POST['account_code'], input_num('default_rate'), isset($_POST['required']) ? 1 : 0, isset($_POST['automatic']) ? 1 : 0);
